...
ALTER TABLE practice_sessions
  ...
  ADD COLUMN positive_marks double precision DEFAULT NULL,
  ADD COLUMN negative_marks double precision DEFAULT NULL,
  ADD COLUMN passing_percentage double precision DEFAULT NULL,
  ...
  ADD COLUMN maximum_marks double precision DEFAULT NULL;
...
ALTER TABLE mock_test_results
  ...
  ADD COLUMN positive_marks_earned double precision NOT NULL DEFAULT 0.0,
  ADD COLUMN negative_marks_deducted double precision NOT NULL DEFAULT 0.0,
  ADD COLUMN average_time_per_question double precision NOT NULL DEFAULT 0.0;
...
ALTER TABLE mock_test_answers
  ADD CONSTRAINT uq_mta_session_question UNIQUE (mock_test_session_id, practice_question_id);
